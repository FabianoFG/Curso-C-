...
public:
    ...
    QPushButton *bto_mostrar;
    QPushButton *bto_limpar;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget->setGeometry(QRect(20, 20, 701, 251));
        ...
        bto_mostrar = new QPushButton(widget);
        bto_mostrar->setObjectName(QString::fromUtf8("bto_mostrar"));

        horizontalLayout_4->addWidget(bto_mostrar);

        bto_limpar = new QPushButton(widget);
        bto_limpar->setObjectName(QString::fromUtf8("bto_limpar"));

        horizontalLayout_4->addWidget(bto_limpar);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        bto_mostrar->setText(QCoreApplication::translate("MainWindow", "Mostrar", nullptr));
        bto_limpar->setText(QCoreApplication::translate("MainWindow", "Limpar", nullptr));
    } // retranslateUi
